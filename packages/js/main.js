...
function validateForm() {
  ...
  if (!/^[A-Za-z\s]+$/.test(name)) {
      errorElement.innerHTML += "Name must contain letters only.<br>";
  }
  ...
  if (subject.trim() === "") {
      errorElement.innerHTML += "Subject cannot be empty.<br>";
  }

  // Validate Description (not empty)
  if (description.trim() === "") {
      errorElement.innerHTML += "Description cannot be empty.<br>";
  }
